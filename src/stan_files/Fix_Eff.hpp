...
namespace model_Fix_Eff_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Fix_Eff");
    reader.add_event(39, 39, "end", "model_Fix_Eff");
    return reader;
}

#include <meta_header.hpp>
 class model_Fix_Eff : public prob_grad {
private:
    int N;
    vector<int> rctrl;
    vector<int> nctrl;
...
public:
    model_Fix_Eff(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Fix_Eff_namespace::model_Fix_Eff";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(ptrt,i,"ptrt",1), inv_logit((get_base1(mu,i,"mu",1) + (theta * 0.5))));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_Fix_Eff_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Fix_Eff_namespace::model_Fix_Eff stan_model;
