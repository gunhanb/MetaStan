...
namespace model_BNHM_Smith_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BNHM_Smith");
    reader.add_event(48, 48, "end", "model_BNHM_Smith");
    return reader;
}

#include <meta_header.hpp>
 class model_BNHM_Smith : public prob_grad {
private:
    int N;
    vector<int> rctrl;
    vector<int> nctrl;
    ...
    int tau_prior_dist;
public:
    model_BNHM_Smith(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BNHM_Smith_namespace::model_BNHM_Smith";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(get_base1_lhs(pctrl,i,"pctrl",1), inv_logit((get_base1(mu,i,"mu",1) - (theta * 0.5))));
                current_statement_begin__ = 32;
                stan::math::assign(get_base1_lhs(ptrt,i,"ptrt",1), inv_logit(((get_base1(mu,i,"mu",1) + (theta * 0.5)) + (get_base1(zeta,i,"zeta",1) * tau))));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_BNHM_Smith_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_BNHM_Smith_namespace::model_BNHM_Smith stan_model;
