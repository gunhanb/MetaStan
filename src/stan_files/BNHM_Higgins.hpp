...
namespace model_BNHM_Higgins_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BNHM_Higgins");
    reader.add_event(46, 46, "end", "model_BNHM_Higgins");
    return reader;
}

#include <meta_header.hpp>
 class model_BNHM_Higgins : public prob_grad {
private:
    int N;
    vector<int> rctrl;
    vector<int> nctrl;
    ...
    int tau_prior_dist;
public:
    model_BNHM_Higgins(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BNHM_Higgins_namespace::model_BNHM_Higgins";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(tau_prior_dist,2))) {
                current_statement_begin__ = 41;
                lp_accum__.add(uniform_log<propto__>(tau, 0, tau_prior));
            }
            current_statement_begin__ = 42;
            if (as_bool(logical_eq(tau_prior_dist,3))) {
                current_statement_begin__ = 42;
                lp_accum__.add(cauchy_log<propto__>(tau, 0, tau_prior));
                if (tau < 0) lp_accum__.add(-std::numeric_limits<double>::infinity());
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_BNHM_Higgins_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_BNHM_Higgins_namespace::model_BNHM_Higgins stan_model;
