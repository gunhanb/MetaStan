...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_SMA");
    reader.add_event(176, 174, "end", "model_SMA");
    return reader;
}
#include <stan_meta_header.hpp>
class model_SMA
  : public stan::model::model_base_crtp<model_SMA> {
private:
        int Nobs;
        vector_d t;
        std::vector<int> st;
        ...
        matrix_d cov;
public:
    model_SMA(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_SMA_namespace::model_SMA";
            ...
            if (as_bool(mreg)) {
                ...
                for (int i = 1; i <= Nobs; ++i) {
                    ...
                    stan::model::assign(temp, 
                                ...
                                ((0.5 * get_base1(get_base1(beta, 1, "beta", 1), 1, "beta", 2)) * get_base1(cov, 1, get_base1(st, i, "st", 1), "cov", 1)), 
                ...
                if (as_bool(logical_eq(ncov, 1))) {
                    ...
                    for (int j = 1; j <= ncov; ++j) {
                        ...
                        for (int i = 1; i <= Nobs; ++i) {
                            ...
                            stan::model::assign(beta_cov, 
                                        stan::model::cons_list(stan::model::index_uni(get_base1(st, i, "st", 1)), stan::model::nil_index_list()), 
                                        (get_base1(temp, get_base1(st, i, "st", 1), "temp", 1) + ((0.5 * get_base1(get_base1(beta, 1, "beta", 1), j, "beta", 2)) * get_base1(cov, j, get_base1(st, i, "st", 1), "cov", 1))), 
                                        "assigning variable beta_cov");
            ...
            if (as_bool(re)) {
                ...
                if (as_bool(ncp)) {
                    ...
                    for (int i = 1; i <= Nobs; ++i) {
                        ...
                        if (as_bool(logical_eq(get_base1(t, i, "t", 1), 0))) {
                            ...
                            stan::model::assign(d, 
                                        ...
                                        (((get_base1(mu, get_base1(st, i, "st", 1), "mu", 1) - (0.5 * theta)) - ((0.5 * get_base1(get_base1(u, 1, "u", 1), get_base1(st, i, "st", 1), "u", 2)) * get_base1(tau, 1, "tau", 1))) - get_base1(beta_cov, get_base1(st, i, "st", 1), "beta_cov", 1)), 
                    ...
                    for (int i = 1; i <= Nobs; ++i) {
                        ...
                        if (as_bool(logical_eq(get_base1(t, i, "t", 1), 0))) {
                            ...
                            stan::model::assign(d, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        ((get_base1(mu, get_base1(st, i, "st", 1), "mu", 1) - (0.5 * get_base1(get_base1(u, 1, "u", 1), get_base1(st, i, "st", 1), "u", 2))) - get_base1(beta_cov, get_base1(st, i, "st", 1), "beta_cov", 1)), 
                                        "assigning variable d");
                        } else {
                ...
                for (int i = 1; i <= Nobs; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(t, i, "t", 1), 0))) {
                        ...
                        stan::model::assign(d, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    ((get_base1(mu, get_base1(st, i, "st", 1), "mu", 1) - (0.5 * theta)) - get_base1(beta_cov, get_base1(st, i, "st", 1), "beta_cov", 1)), 
                                    "assigning variable d");
                    } else {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_SMA_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_SMA_namespace::model_SMA stan_model;
#ifndef USING_R
