...
vignette: >
  %\VignetteIndexEntry{Conducting meta-analysis using MetaStan}
...
```{r bnhmFit, results="hide"}
 ...
 meta.BCG.stan  <- meta_stan(data = dat_long,
                            family = "binomial",
                            mu_prior = c(0, 10),
                            theta_prior = c(0, 100),
                            tau_prior = 0.5,
...
launch_shinystan(meta.BCG.stan)
```
...
Jackson, D et al. (2018). "A comparison of seven random-effects models for meta-analyses
